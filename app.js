  ...
  "DRUNK": {
    ...
    const TYPE_IMAGES = {
	  "IMSB": "./assets/posters/imsb.webp",
	  "BOSS": "./assets/posters/boss.webp",
	  "MUM": "./assets/posters/mum.webp",
	  "FAKE": "./assets/posters/fake.webp",
	  "Dior-s": "./assets/posters/dior-s.webp",
	  "DEAD": "./assets/posters/dead.webp",
	  "ZZZZ": "./assets/posters/zzzz.webp",
	  "GOGO": "./assets/posters/gogo.webp",
	  "FUCK": "./assets/posters/fuck.webp",
	  "CTRL": "./assets/posters/ctrl.webp",
	  "HHHH": "./assets/posters/hhhh.webp",
	  "SEXY": "./assets/posters/sexy.webp",
	  "OJBK": "./assets/posters/ojbk.webp",
	  "JOKE-R": "./assets/posters/joke-r.webp",
	  "POOR": "./assets/posters/poor.webp",
	  "OH-NO": "./assets/posters/oh-no.webp",
	  "MONK": "./assets/posters/monk.webp",
	  "SHIT": "./assets/posters/shit.webp",
	  "THAN-K": "./assets/posters/than-k.webp",
	  "MALO": "./assets/posters/malo.webp",
	  "ATM-er": "./assets/posters/atm-er.webp",
	  "THIN-K": "./assets/posters/thin-k.webp",
	  "SOLO": "./assets/posters/solo.webp",
	  "LOVE-R": "./assets/posters/love-r.webp",
	  "WOC!": "./assets/posters/woc.webp",
	  "DRUNK": "./assets/posters/drunk.webp",
	  "IMFW": "./assets/posters/imfw.webp"
};
  ...
  "So3": {
    ...
    const screens = {
      ...
      result: document.getElementById('result')
	    ...
	    const resultNodes = {
	      modeKicker: document.getElementById('resultModeKicker'),
	      typeName: document.getElementById('resultTypeName'),
	      matchBadge: document.getElementById('matchBadge'),
	      typeSub: document.getElementById('resultTypeSub'),
	    ...
	    function renderQuestions() {
          ...
          <div class="question-meta">
            ...
            <div>${getQuestionMetaLabel(q)}</div>
	          ...
	          <div class="options">
	            ${q.options.map((opt, i) => {
	              const code = optionCodes[i] || String(i + 1);
    ...
    function computeResult() {
      ...
      return {
	    ...
	    function renderDimList(result) {
	      resultNodes.dimList.innerHTML = dimensionOrder.map(dim => {
	    ...
	    function renderResult() {
	      ...
	      resultNodes.modeKicker.textContent = result.modeKicker;
	      resultNodes.typeName.textContent = `${type.code}（${type.cn}）`;
	      resultNodes.matchBadge.textContent = result.badge;
	      resultNodes.typeSub.textContent = result.sub;
	      resultNodes.desc.textContent = type.desc;
	      resultNodes.posterCaption.textContent = type.intro;
	      resultNodes.funNote.textContent = result.special
	      ...
	      if (imageSrc) {
	        resultNodes.posterImage.src = imageSrc;
	        resultNodes.posterImage.alt = `${type.code}（${type.cn}）`;
	        resultNodes.posterBox.classList.remove('no-image');
	      } else {
	        resultNodes.posterImage.removeAttribute('src');
	        resultNodes.posterImage.alt = '';
	        resultNodes.posterBox.classList.add('no-image');
	      }
